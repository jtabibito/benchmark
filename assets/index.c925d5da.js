import{f,g as T,h as nn,i as A,V as m,j as $,K as C,k as R,l as L,C as k,m as Y,n as ee,o as ne,R as Ve,T as Be,p as rn,q as tn,r as an,s as on,t as J,u as ln,v as He,M as V,Q as N,w as ve,D as fe,x as ge,y as pe,z as xe,E as ie,F as Oe,G as Ge,H as je,B as sn,I as un,J as _n,N as cn,O as z,U as dn,X as mn,L as hn,Y as ye,b as vn,Z as fn,_ as Ke}from"./module.c2be8446.js";function Ce(a,n){for(var s=0;s<n.length;s++){var r=n[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(a,r.key,r)}}function gn(a,n,s){return n&&Ce(a.prototype,n),s&&Ce(a,s),a}function oe(a,n){return oe=Object.setPrototypeOf||function(r,e){return r.__proto__=e,r},oe(a,n)}function pn(a,n){if(typeof n!="function"&&n!==null)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(n&&n.prototype,{constructor:{value:a,writable:!0,configurable:!0}}),n&&oe(a,n)}f.getByName("u_width");f.getByName("u_min");f.getByName("u_max");f.getByName("u_boxColor");f.getByName("u_borderColor");T.create("box",`
#include <common>
#include <common_vert>
...
#include <position_vert>
    ...
    `);T.create("planarShadowShader",[T.find("pbr").subShaders[0].passes[0],En]);function Me(a,n){for(var s=0;s<n.length;s++){var r=n[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(a,r.key,r)}}function bn(a,n,s){return n&&Me(a.prototype,n),s&&Me(a,s),a}function _e(a,n){return _e=Object.setPrototypeOf||function(r,e){return r.__proto__=e,r},_e(a,n)}function Sn(a,n){if(typeof n!="function"&&n!==null)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(n&&n.prototype,{constructor:{value:a,writable:!0,configurable:!0}}),n&&_e(a,n)}f.getByName("u_far");f.getByName("u_near");f.getByName("u_primaryScale");f.getByName("u_secondaryScale");f.getByName("u_gridIntensity");f.getByName("u_axisIntensity");f.getByName("u_flipProgress");f.getByName("u_fade");T.create("grid",`
#include <common>
#include <common_vert>
...
`;T.create("bake-pbr",zn,Wn);f.getByName("u_lightMapTexture");f.getByName("u_lightMapIntensity");var $e=function(a){Sn(n,a);function n(r){var e;e=a.call(this,r,T.find("plain-color"))||this;var i=e.shaderData;return i.enableMacro("MATERIAL_OMIT_NORMAL"),i.setColor(n._baseColorProp,new J(1,1,1,1)),e.renderState.rasterState.cullMode=ln.Off,e}var s=n.prototype;return s.clone=function(){var e=new n(this._engine);return this.cloneTo(e),e},bn(n,[{key:"baseColor",get:function(){return this.shaderData.getColor(n._baseColorProp)},set:function(e){var i=this.shaderData.getColor(n._baseColorProp);e!==i&&i.copyFrom(e)}}]),n}(He);T.create("plain-color",`
#include <common>
#include <common_vert>
#include <blendShape_input>
